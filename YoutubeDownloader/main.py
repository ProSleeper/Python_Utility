...
yt = YouTube('https://music.youtube.com/watch?v=BBM6-svSXjM&feature=share')
...
# video.audio.write_audiofile(save_name)



# 아무리 뭔짓을 해도 file path를 못 읽는다. 아래 코드는 mp3로 변환된 파일의 bitrate를 320k로 변환하려고 한건데 해당 이유 때문에 안된다.
# 뭐 다른 방법 사용해보면 되겠지!
# sound = AudioSegment.from_file(os.path.join(os.path.dirname(__file__), save_name))
